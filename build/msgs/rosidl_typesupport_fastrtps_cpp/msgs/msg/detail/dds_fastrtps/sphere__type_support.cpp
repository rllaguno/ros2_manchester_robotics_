...
#include "msgs/msg/detail/sphere__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const msgs::msg::Sphere & ros_message,
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = msgs::msg::Sphere;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const msgs::msg::Sphere *>(
    untyped_ros_message);
...
{
  return &msgs::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msgs, msg, Sphere)() {
  return &msgs::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
